...
def displayMenu():
    ...
    print ('Bienvenue dans le menu. Merci de saisir le numéro correspondant à la destination voulue.')
    print("\n")
    ...
    print('11 : Calculer et afficher les moyennes générales des élèves selon leurs rangs')
...
def userChoice():
    ...
    while user_input not in list(range(1,18)):
        ...
        user_input = int(input('Merci de saisir le numéro correspondant à la destination voulue : '))
        ...
        print(f'Vous vaez choisi {user_input}, redirection vers {selected[user_input-1]}')
